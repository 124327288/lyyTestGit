		...
		)
{
	...
	case KP_EFFECTIVE_KEYLEN:
		...
		break;
	case KP_KEYVAL:
		CreatebyBlob(pbData, (m_ulKeyLen)/8);
		break;
	default:
		...
		)
{
	...
	case KP_EFFECTIVE_KEYLEN:
		...
		break;
	case KP_KEYVAL:
		return GetKeyMaterial(pbData, pdwDataLen);
		break;
	default:
		{
			SETLASTERROR(NTE_BAD_TYPE);
