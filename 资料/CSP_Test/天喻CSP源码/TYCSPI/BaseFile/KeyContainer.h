...
class CCSPKey;
typedef CArrayTemplate<CCSPHashObject*, CCSPHashObject*> CCSPHashObjectPtrArray;
typedef CArrayTemplate<CCSPKey*, CCSPKey*> CCSPKeyPtrArray;
...
public:
	...
	//销毁指定算法标识的密钥对
	BOOL DestroyKeyPair(ALG_ID algId);
protected:
	//删除HASH对象
