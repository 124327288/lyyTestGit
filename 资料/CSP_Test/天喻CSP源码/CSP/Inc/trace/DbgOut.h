...
class CTraceFunction2{
private:
	TCHAR*	m_szFunctionName;
public:
	CTraceFunction2(LPCTSTR lpszFunctionName)
	{
		m_szFunctionName = NULL;
...
#define TRACE_FUNCTION2(szFuncName); \
	CTraceFunction2 tf(szFuncName); \

#define TRACE_FUNCTION_ENTER(szFuncName); \
	TRACE_LINE("\n@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n"); \
	TRACE_LINE("@Enter Function: %s\n", szFuncName); \


#define TRACE_FUNCTION_EXIT(szFuncName); \
	TRACE_LINE("\n@Exit Function: %s\n", szFuncName); \
	TRACE_LINE("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n"); \
