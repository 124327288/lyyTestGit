...
#ifdef WIN32
extern struct tcsd_op tcsd_op_seal;
extern struct tcsd_op tcsd_op_unseal;
extern struct tcsd_op tcsd_op_registerkey;
extern struct tcsd_op tcsd_op_unregisterkey;
extern struct tcsd_op tcsd_op_getregisteredkeybypublicinfo;
extern struct tcsd_op tcsd_op_getpubkey;
extern struct tcsd_op tcsd_op_loadkey;
extern struct tcsd_op tcsd_op_createkey;
extern struct tcsd_op tcsd_op_sign;
extern struct tcsd_op tcsd_op_random;
extern struct tcsd_op tcsd_op_getcapability;
extern struct tcsd_op tcsd_op_unbind;
extern struct tcsd_op tcsd_op_quote;
extern struct tcsd_op tcsd_op_readpubek;
extern struct tcsd_op tcsd_op_selftest;

extern struct tcsd_op *tcsd_ops[];
#else
