...
#define TPM_SHA1_160_HASH_LEN    0x20

#else
//////////////////////////////////////////////////////////////////////////
// modify by 吴庆
// 2008/3/27
// TCM 模块采用 SCH 算法, 长度32 字节
#define TPM_SHA1_160_HASH_LEN    (0x20)
...
/*
typedef struct tdTCM_KEY{                      length   total
TCM_STRUCTURE_TAG tag;                       2byte              
UINT16 fill;                                 2byte        
TCM_KEY_USAGE keyUsage;                      2byte         
TCM_KEY_FLAGS keyFlags;                      4byte         
TCM_AUTH_DATA_USAGE authDataUsage;           1byte         
TCM_KEY_PARMS algorithmParms;	       max    22byte  
UINT32 PCRInfoSize;                          4byte  
BYTE* PCRInfo;                       max    80byte  
TCM_STORE_PUBKEY  	pubKey;           max    69byte  
UINT32 encDataSize;                          4byte  
[size_is(encDataSize)] BYTE* encData;max   230byte  
} TCM_KEY;                              max   420byte
