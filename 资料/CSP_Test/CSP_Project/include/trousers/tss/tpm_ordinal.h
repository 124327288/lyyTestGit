...
#define TPM_PROTECTED_ORDINAL              ((UINT32)0x00008000)//(TPM_MAIN | TPM_PROTECTED_COMMAND)
#define TPM_UNPROTECTED_ORDINAL            (TPM_MAIN | TPM_UNPROTECTED_COMMAND)
#define TPM_CONNECTION_ORDINAL             (TPM_MAIN | TPM_CONNECTION_COMMAND)

#define TPM_ORD_APCreate                          TPM_PROTECTED_ORDINAL+((UINT32)0x000000BF)
#define TPM_ORD_APTerminate                       TPM_PROTECTED_ORDINAL+((UINT32)0x000000C0)
...
#define TPM_ORD_LoadKey                           TPM_PROTECTED_ORDINAL+((UINT32)0x000000EF)
...
//#define TPM_ORD_OwnerReadPubek                    TPM_PROTECTED_ORDINAL+((UINT32)0x00000081)
...
#define TPM_ORD_CreateMigrationBlob               TPM_PROTECTED_ORDINAL+((UINT32)0x000000C1)
#define TPM_ORD_AuthorizeMigrationKey             TPM_PROTECTED_ORDINAL+((UINT32)0x000000C3)
