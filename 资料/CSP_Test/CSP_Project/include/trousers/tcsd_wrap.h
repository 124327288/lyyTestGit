...
enum TCSD_ORD {
	...
	TCSD_ORD_SMS4ENCRYPT = 125,
	TCSD_ORD_SMS4DECRYPT = 126,
	TCSD_ORD_COLLATEPEKREQUEST = 127,
	TCSD_ORD_ACTIVATEPEK       = 128,
	TCSD_ORD_ACTIVATEPEKCERT   = 129,
