...
struct tcsd_config
{
	...
	char system_ps_dir[260];	/* the directory the system PS file sits in */
	char system_ps_file[260];	/* the name of the system PS file */
	char firmware_log_file[260];/* the name of the firmware PCR event file */
	char kernel_log_file[260];	/* the name of the kernel PCR event file */
	...
	char endorsement_cred[260];		/* location of the endorsement credential */
...
#ifndef WIN32
#define TCSD_CONFIG_FILE	 "/tcsd.conf"
#else
#define TCSD_CONFIG_FILE	 "tcsd.conf"
#endif
...
#ifndef WIN32
#define TCSD_DEFAULT_ENDORSEMENT_CRED_FILE  "/lib/tpm/endorsement_cred"
#define TCSD_DEFAULT_SYSTEM_PS_FILE	"/lib/tpm/system.data"
#define TCSD_DEFAULT_SYSTEM_PS_DIR	"/lib/tpm"
...
#else
#define TCSD_DEFAULT_ENDORSEMENT_CRED_FILE  "endorsement_cred"
#define TCSD_DEFAULT_SYSTEM_PS_FILE	"system.data"
#define TCSD_DEFAULT_SYSTEM_PS_DIR	"lib/tpm"
#define TCSD_DEFAULT_FIRMWARE_LOG_FILE	"binary_bios_measurements"
#define TCSD_DEFAULT_KERNEL_LOG_FILE	"binary_runtime_measurements"
#endif
...
typedef struct tcsd_thread_data
{
	int sock;
	UINT32 context;
