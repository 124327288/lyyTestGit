...
// add by 杨国华
// 时间: 2008/03/26
//free all context memory--add by YGH
TSS_RESULT free_context_memory_all();
//free specific context memory--add by YGH
TSS_RESULT free_context_memory(TCS_CONTEXT_HANDLE handle);
//end add by  杨国华
//////////////////////////////////////////////////////////////////////////
...
TSS_RESULT TCSP_FlushSpecific_Common(UINT32, TPM_RESOURCE_TYPE);
    ...
    TSS_RESULT TCS_UnregisterKey_Internal(
    ...
    TSS_RESULT TCSP_ReadCurrentTicks_Internal(TCS_CONTEXT_HANDLE hContext,TPM_CURRENT_TICKS *tick);
