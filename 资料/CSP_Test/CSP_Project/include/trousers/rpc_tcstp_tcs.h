...
DECLARE_TCSTP_FUNC(APTerminate);
DECLARE_TCSTP_FUNC(SMS4Encrypt);
DECLARE_TCSTP_FUNC(SMS4Decrypt);
DECLARE_TCSTP_FUNC(CollatePekRequest);
DECLARE_TCSTP_FUNC(ActivatePEK);
DECLARE_TCSTP_FUNC(ActivatePEKCert);
...
int recv_from_socket(int, unsigned char *, int);
int send_to_socket(int, unsigned char *, int);
