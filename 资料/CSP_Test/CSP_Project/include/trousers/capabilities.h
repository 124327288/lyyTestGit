...
/* TSP */
/* BOOL */
#define INTERNAL_CAP_TSP_ALG_RSA		FALSE
#define INTERNAL_CAP_TSP_ALG_SHA		FALSE
...
#define INTERNAL_CAP_VERSION			{ 1, 0, TSS_VER_MAJOR, TSS_VER_MINOR }

#define INTERNAL_CAP_MANUFACTURER_ID		0x4A574953	//"JWIS"
//#define INTERNAL_CAP_MANUFACTURER_STR		{ 'I', 0, 'B', 0, 'M', 0, 0, 0 }
#define INTERNAL_CAP_MANUFACTURER_STR		L"Jetway Information Security CO.LTD\0"
#define INTERNAL_CAP_MANUFACTURER_STR_LEN	sizeof(INTERNAL_CAP_MANUFACTURER_STR)
